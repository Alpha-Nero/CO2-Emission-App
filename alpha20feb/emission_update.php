 ...
 ?>
            ...
            <div class="content-page">
                ...
                <div class="col-sm-6" style="text-align:left;">
					<h4 style="margin-left: 15px;">Edit Emission</h4>
				</div>
                    ...
                    <h5 class="card-title">Enter Emission Values </h5>
              ...
              <div class="row">
                ...
                <div class="col-md-6" style="padding-left:250px!important;">
					...
					<form  method="POST" action ="emission_update_code.php" onsubmit="return onFormSubmit(this);">
            ...
            <div class="card" style="margin-bottom:20px ;">
                <div class="card-body">
                   <div class="row">
                    ...
                    <h3 class="card-title">
                            <a href="table_emission.php" style="margin-left:0%; width:80px; height:37px; border-radius:4px; border:none;cursor: pointer;" class="btn btn-info btn-success float-left">Back</a>
                        </h3>
                    </div>
                    <div class="col-md-2">
                    <div class="row">
...
<br>
          ...
          $data_source_id=$value_source['data_source_id'];
           //  print_r($value1['data_source_id']);
            ...
            <h5 style="margin-left: 10px; text-align:left;"><?php print_r($value_group['data_source_group_name'])?></h5>
			...
			<div class="row" style="padding-top:25px!important;" >
					...
					<div class="col-4" style="width: 40%;  margin-left:0%" >
						<div class="form-group" >
         ...
         //  echo $data_source_id."  ".$data_source_group_id.$year;
            $sql3= "SELECT * FROM  emission_factors as ef 
            join data_source_subcategory as dss on ef.data_source_subcategory_id = dss.data_source_subcategory_id 
            WHERE ef.year=$year and dss.data_source_id=$data_source_id and dss.data_source_group_id=$data_source_group_id";
           ...
           // print_r($data_subcategory);
            ...
            ?>
				...
				<div class="row">
					...
					<div class="col-4" style="width: 100%;  margin-left:0%" >
						<div class="form-group" >
					...
					<div class="col-2"  style="width: 15%;  margin-left:12%" >
						<div class="form-group" >
						<select class="form-control select2 " name="scope[]" value="<?php echo $emission_factors[$in]['scope']?>" data-dropdown-css-class="select2" required>
								<option value="">Select</option>
                <?php 
						        for($i=0;$i<count($scope); $i++){
									if($value_subcategory['scope']==$scope[$i]){
				?>
					                <option value="<?php echo $value_subcategory['scope']; ?>" selected><?php print_r($scope[$i]);?></option>

				<?php
									}else{

                 ?>
                                 <option><?php print_r($scope[$i]) ?>
								</option>
                 <?php }
                }
                ?>
					...
					<div class="col-2"  style="width: 15%;  margin-left:1%" >
						<div class="form-group">
							<input type="text" class="form-control" name="emission_factors_value[]" value="<?php echo $value_subcategory['emission_factors_value'] ?>" placeholder="Enter Value" >
                            ...
                            <input type="hidden" class="form-control" name="emission_factors_id[]" value="<?php echo $value_subcategory['emission_factors_id']?>" placeholder="Enter Value" >
                            <input type="hidden" class="form-control" name="year" value="<?php echo $year?>" placeholder="Enter Value" >
						</div>
					</div>
				...
				<!--	<div class="col-2"  style="width: 12%;  margin-left:1%" >
						<div class="form-group" >
                            ...
                            <input type="text" class="form-control" name="unit[]"  value="<?php echo $value_subcategory['unit'] ?>" placeholder="Enter Unit" >
						</div>
					</div>-->
				</div>
...
// first loop end
		...
		//echo "$count";
			...
			<div class="card-footer">
				<input type="submit" style="" class="btn btn-info" name="submit" value="Update Emission" >
