	...
	?>
				...
				<div class="content-page">
					...
					<div class="col-sm-6" style="text-align:left;">
						<h4 style="margin-left: 15px;">Add Emission</h4>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-6" style="padding-left:250px!important;">
						...
						<form  method="POST" action ="emission_code.php" onsubmit="return onFormSubmit(this);">
	...
	// first loop end
			...
			//echo "$count";
				...
				<div class="card-footer">
					<input type="submit"  class="btn btn-info" style="" name="submit" value="Save Emission" >
